# ADR-0012: Ephemeral (PR-preview) environments deploy through `idp-application`, TTL-swept
...
Ephemeral environments deploy through `idp-application` - the same Helm chart every
